...
<div class="page-content-wrapper">
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="card">
                <div class="card-header text-muted">Default user role is a <strong>viewer</strong>. You can modify user role after creating one.</div>
                <div class="card-body register-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-2 col-form-label text-md-end">{{ __('Id Number') }}</label>
