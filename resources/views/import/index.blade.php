...
<div id="page-content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="import-content">
            <p>Import files with the extension name(.xlsx) <a href="{{ asset('help-info/Help-Import.pdf') }}" target="_blank" title="Help/Tutorial"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="20px" fill="#0000EE">
