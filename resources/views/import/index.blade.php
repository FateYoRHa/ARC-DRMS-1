            ...
            <form action="{{ route('file-import') }}" method="POST" id="formImport" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="progress mt-2">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%" role="progressbar"> <div id="spinner"></div></div>
                    </div>
                </div>
